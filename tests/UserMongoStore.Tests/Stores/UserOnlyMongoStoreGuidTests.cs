...
public sealed class UserOnlyMongoStoreGuidTests
{
    private UserOnlyMongoStoreAsGuid<ApplicationUserGuid> _userMongoStore;
    ...
    public void Setup()
    {
        ...
        var database = client.GetDatabase("UserOnlyMongoStoreGuidTests");

        var userCollection = database.GetCollection<ApplicationUserGuid>("ApplicationUser");

        _userMongoStore =
            new UserOnlyMongoStoreAsGuid<ApplicationUserGuid>(new IdentityErrorDescriber(), userCollection);
    }
