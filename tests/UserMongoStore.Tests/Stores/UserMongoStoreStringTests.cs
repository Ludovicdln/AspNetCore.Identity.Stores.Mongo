...
public sealed class UserMongoStoreStringTests
{
    private UserMongoStore<ApplicationUserString, ApplicationRoleString> _userMongoStore;
    ...
    public void Setup()
    {
        ...
        var database = client.GetDatabase("UserMongoStoreStringTests");
        ...
        _userMongoStore =
            new UserMongoStore<ApplicationUserString, ApplicationRoleString>(new IdentityErrorDescriber(), userCollection,
                roleCollection);

        _roleMongoStore = new RoleMongoStore<ApplicationRoleString>(new IdentityErrorDescriber(), roleCollection);
    }
    ...
    public async Task GetId_ShouldReturnIdToString()
    {
        ...
        Assert.That(idToString, Is.EqualTo(userExist.Id));
    }
    ...
    [Test]
    public void  CreateIdentityUserAsString_ShouldGenerateString()
    {
        var user = new ApplicationUserString()
        {
            Email = "test2@gmail.com",
    ...
    public async Task AddToRole_ShouldSuccess()
    {
        ...
        var appRole = new ApplicationRoleString()
        {
            Name = "role_test_3",
    ...
    public async Task AddToRoleAlreadyExist_ShouldNotSuccess()
    {
        ...
        user.Roles.Add(new MongoRole<string>(appRole.Id, appRole.Name, appRole.NormalizedName));
    ...
    public async Task IsInRole_ShouldReturnTrue()
    {
        ...
        var role = new MongoRole<string>(appRole.Id, "role_test", "role_test".ToUpper());
    ...
    public async Task GetRoles_ShouldReturnListOfNames()
    {
        ...
        var appRole2 = new ApplicationRoleString()
        {
            Name = "role_test_5",
            NormalizedName = "role_test_5".ToUpper()
        };
        
        var role = new MongoRole<string>(appRole.Id, appRole.Name, appRole.NormalizedName.ToUpper());
        
        var role2 = new MongoRole<string>(appRole2.Id, appRole2.Name, appRole2.NormalizedName.ToUpper());
    ...
    public async Task GetUsersInRole_ShouldReturnListOfUser()
    {
        ...
        user2.Roles.Add(new MongoRole<string>(appRole.Id, appRole.Name, appRole.NormalizedName));
