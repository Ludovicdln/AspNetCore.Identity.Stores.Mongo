...
public class UserMongoStoreGuidTests
{
    private UserMongoStoreAsGuid<ApplicationUserGuid, ApplicationRoleGuid> _userMongoStore;
    ...
    public void Setup()
    {
        ...
        var database = client.GetDatabase("UserMongoStoreGuidTests");

        var userCollection = database.GetCollection<ApplicationUserGuid>("ApplicationUser");

        var roleCollection = database.GetCollection<ApplicationRoleGuid>("ApplicationRole");

        _userMongoStore =
            new UserMongoStoreAsGuid<ApplicationUserGuid, ApplicationRoleGuid>(new IdentityErrorDescriber(), userCollection,
                roleCollection);

        _roleMongoStore = new RoleMongoStoreAsGuid<ApplicationRoleGuid>(new IdentityErrorDescriber(), roleCollection);
    }
    ...
    public async Task UpdateAllProperties_ShouldReturnSuccess()
    {
        ...
        user.Roles = new List<MongoRole<Guid>>()
            { new(Guid.NewGuid(), "role1_test", "ROLE1_TEST"), new(Guid.NewGuid(), "role2_test", "ROLE2_TEST") };
    ...
    public async Task GetUsersForClaims_ShouldReturnUsers()
    {
        ...
        var user2 = new ApplicationUserGuid()
        {
    ...
    public async Task AddToRole_ShouldSuccess()
    {
        ...
        var appRole = new ApplicationRoleGuid()
        {
            Name = "role_test_3",
    ...
    public async Task AddToRoleAlreadyExist_ShouldNotSuccess()
    {
        ...
        user.Roles.Add(new MongoRole<Guid>(appRole.Id, appRole.Name, appRole.NormalizedName));
    ...
    public async Task IsInRole_ShouldReturnTrue()
    {
        ...
        var role = new MongoRole<Guid>(appRole.Id, "role_test", "role_test".ToUpper());
    ...
    public async Task GetRoles_ShouldReturnListOfNames()
    {
        ...
        var appRole2 = new ApplicationRoleGuid()
        {
            Name = "role_test_5",
            NormalizedName = "role_test_5".ToUpper()
        };
        
        var role = new MongoRole<Guid>(appRole.Id, appRole.Name, appRole.NormalizedName.ToUpper());
        
        var role2 = new MongoRole<Guid>(appRole2.Id, appRole2.Name, appRole2.NormalizedName.ToUpper());
    ...
    public async Task GetUsersInRole_ShouldReturnListOfUser()
    {
        ...
        user2.Roles.Add(new MongoRole<Guid>(appRole.Id, appRole.Name, appRole.NormalizedName));
