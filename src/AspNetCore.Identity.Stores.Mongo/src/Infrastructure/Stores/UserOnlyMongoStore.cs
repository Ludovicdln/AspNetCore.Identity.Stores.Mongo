...
public class UserOnlyMongoStoreAsObjectId<TUser> : UserOnlyMongoStore<TUser, ObjectId, IdentityUserClaim<ObjectId>,
    MongoIdentityUserLogin<ObjectId>, IdentityUserToken<ObjectId>>
    where TUser : MongoIdentityUser<ObjectId>, new()
{
    public UserOnlyMongoStoreAsObjectId(IdentityErrorDescriber describer, IMongoCollection<TUser> userCollection) 
        : base(describer, userCollection)
    {
    }
...
/// </summary>
/// <typeparam name="TUser">The type representing a user.</typeparam>
public class UserOnlyMongoStoreAsGuid<TUser> : UserOnlyMongoStore<TUser, Guid, IdentityUserClaim<Guid>,
    MongoIdentityUserLogin<Guid>, IdentityUserToken<Guid>>
    where TUser : MongoIdentityUser<Guid>, new()
{
    public UserOnlyMongoStoreAsGuid(IdentityErrorDescriber describer, IMongoCollection<TUser> userCollection) 
        : base(describer, userCollection)
    {
    }
...
/// </summary>
/// <typeparam name="TUser">The type representing a user.</typeparam>
public class UserOnlyMongoStore<TUser> : UserOnlyMongoStore<TUser, string, IdentityUserClaim<string>,
    MongoIdentityUserLogin<string>, IdentityUserToken<string>>
    where TUser : MongoIdentityUser<string>, new()
{
    public UserOnlyMongoStore(IdentityErrorDescriber describer, IMongoCollection<TUser> userCollection) 
        : base(describer, userCollection)
    {
    }
}
...
public class UserOnlyMongoStore<TUser, TKey> : UserOnlyMongoStore<TUser, TKey, IdentityUserClaim<TKey>,
    MongoIdentityUserLogin<TKey>, IdentityUserToken<TKey>>
...
public class UserOnlyMongoStore<TUser, TKey, TUserClaim, TUserLogin, TUserToken>
    ...
    where TUserToken : IdentityUserToken<TKey>, new()
{
    ...
    protected UserOnlyMongoStore(IdentityErrorDescriber describer, IMongoCollection<TUser> userCollection) : base(describer)
    {
